...
\todo{MOVE THE FOLLOWING PARAGRAPH }
...
\todo{rivedere l'aggancio facendo riferimento alla \Cref{sec:back:dt:technology}}
...
\begin{figure}[tb]
    ...
    \caption{Schematic Event-Driven architecture of a \ac{DT} to support Augmentation function management and execution.}
