...
%
Through an approach inspired by the hypermedia nature of the Web~\cite{fielding2000architectural} and the \acl{WoT}~\cite{wot-arch} a prototype for a \emph{\ac{HWoDT}} which can be used to implement heterogeneous \acp{DTE} is developed~\cite{DBLP:journals/fgcs/GiulianelliBCR26}.
%
