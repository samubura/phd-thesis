...
\begin{figure*}[ht]
    \centering
    \subfigure[\textbf{Monolithic} \ac{DTE}]{
        \includegraphics[width=0.25\textwidth]{figures/hwodt/ecosystems_types-monolithic.pdf}
        \label{fig:ecosystem-monolithic}
    }    
    \subfigure[\textbf{Homogeneous} \ac{DTE}]{
        \includegraphics[width=0.25\textwidth]{figures/hwodt/ecosystems_types-homogeneous.pdf}
        \label{fig:ecosystem-homogeneous}
    }    
    \subfigure[\textbf{Heterogeneous} \ac{DTE}]{
        \includegraphics[width=0.25\textwidth]{figures/hwodt/ecosystems_types-heterogeneous.pdf}
