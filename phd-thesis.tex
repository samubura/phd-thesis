...
%
Ispirandosi alla natura basata su hypermedia del Web e al \acl{WoT}, è stato sviluppato un prototipo di \emph{\ac{HWoDT}} per l'implementazione di \acs{DTE}.
%
...
The work further propose the \ac{DTE} as a layer of abstraction to support the development of intelligent applications which can exploit its capabilities to acquire a comprehensive view of the physical world and automate processes.
%
...
%
Through an approach inspired by the hypermedia nature of the Web and the \acl{WoT} a prototype for a \emph{\ac{HWoDT}} which can be used to implement heterogeneous \acp{DTE} is developed.
%
Finally, the thesis investigates the use of \acp{MAS} as a way to implement trustworthy intelligent applications in \ac{DTE}, defining their relationship with \acp{DT} and contributing to the engineering of \ac{MAS} based on the \acl{BDI} model.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{11096247,11096178,DBLP:conf/icsa/PiconeMBBFBGR25}}
...
\label{chap:dte:dte}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:conf/models/GiulianelliBCR24,DBLP:journals/fgcs/GiulianelliBCR26}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:conf/models/GiulianelliBCR24,DBLP:journals/fgcs/GiulianelliBCR26,GIULIANELLI2025102275}}
...
\label{chap:dte:dtc}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:conf/icccn/BarboneBMPRV24}}
\input{chapters/dte/dtc}

%****************************************************************************************
%****************************************************************************************
\part{Intelligent Applications with \aclp{DT} and \aclp{MAS}}
\label{part:mas}
%****************************************************************************************
%****************************************************************************************
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:journals/iot/BurattiniMMPR25}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{
  DBLP:conf/eumas/Burattini23,
  DBLP:journals/sncs/BaiardiBCP24,
  DBLP:conf/emas/BaiardiBCPRO24,
  baiardi2025jaktasim,
  burattini2025gap,
  embodiment2025,
  Ciatto_Aguzzi_Battistini_Baiardi_Burattini_Ricci_2025,
  DBLP:journals/aamas/HubnerBRM25,
  DBLP:conf/woa/YanBHR23,
  beaumont2025engineering}} 
...
\label{chap:app:irst}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:conf/percom/BurattiniMGGVZCR24}}
\input{chapters/application/irst}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Trauma Management}
\label{chap:app:trauma}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:journals/fgcs/GiulianelliBCR26}}
\input{chapters/application/trauma}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \chapter{Personnel Shifts Management}
% \label{chap:val:ER}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{chapters/application/ER}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\acl{ORM}}
\label{chap:app:orm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mypapers{\cite{DBLP:conf/cbms/BurattiniMCGRLPT23}}
\input{chapters/application/orm}
...
\chapterOutsidePart{Funding}

This work has been funded by the European Union - NextGenerationEU and Azienda Unità Sanitaria Locale (AUSL) della Romagna through the Italian "National Recovery and Resilience Plan" (PNRR) Mission 4, Component 2, Investment 3.3 (DM 352/2022) - CUP J33C22001400009


\begin{figure*}[h!]
  \centering
  \centerline{
    \includegraphics[width=1.1\textwidth]{figures/logo-pnrr.png}
  }
\end{figure*}
