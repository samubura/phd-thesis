...
%
In this example, the use of the HL7 \ac{FHIR} standard to unify healthcare data coming from different sources greatly improves the quality of the information generated by the \ac{DT} ecosystem.
%
Hence, this effort is considered a valuable trade-off for the benefits it can bring to the overall ecosystem.
