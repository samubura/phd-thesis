...
\note{TODO: a section on DT in healthcare with example and challenges}

\note{Since in the previous chapter on healthcare 4.0 DTs are not introduced yet, this ties in to the main application domain of the thesis}
