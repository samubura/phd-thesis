...
\todo{Detail here better how this chapter relates to the core contribution on Digital Twins}
...
focusing on addressing challenges that would make agents easier to develop and integrate with external systems, with a specific focus on hypermedia-based systems, linking to the proposal of \ac{hMAS} and the \ac{HWoDT}~\Cref{chap:dte:hwodt}.
%
