...
%
Among the main technical challenges, issues related to data privacy and security, as well as data fragmentation and lack of standardization are the most relevant. These challenges stem from the heterogeneity of systems and the insufficient incentives for data sharing across organizations.
%
...
This thesis looks at the emerging paradigm of \acp{DT} \cite{Semeraro_Lezoche_Panetto_Dassisti_2021} as a potential solution to address the technical challenges of Healthcare 4.0, focusing on the role of \acp{DT} as enablers of interoperability and integration of heterogeneous systems and data sources in healthcare~\cite{Alazab_Khan_Koppu_Ramu_M_Boobalan_Baker_Maddikunta_Gadekallu_Aljuhani_2023}.
...
%
Nevertheless, hospital information systems continue to play a crucial role as the prominent example of healthcare \ac{ICT} systems and hence why this section refers to \ac{HIS} as hospital information systems.
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/mappa_ausl.png} 
