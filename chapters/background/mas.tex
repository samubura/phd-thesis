...
\note{Methodologies, e.g. Gaia, Tropos, MaSE, Prometheus}

\note{AOP and MAOP}

\note{Programming dimensions of MAOP}

\note{Agents and Artifacts}
...
\note{Rao and Georgeff, PRS}

\note{AgentSpeak, Jason and other languages}
