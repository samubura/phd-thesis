...
\begin{figure}[tb]
    ...
    \caption{Schematic representation of the \ac{DT} lifecycle with a structured example of the \texttt{Synchronized} phase. The images shows that within the \texttt{Synchronized} phase, the \ac{DT} reflects the \ac{PA}'s operational phases, such as \texttt{Ready}, \texttt{Working}, \texttt{Busy}.}
